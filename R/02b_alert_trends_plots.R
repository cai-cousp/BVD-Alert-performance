...
#   - alert_case_trends_thresholds.png   : same, PNG version
...
#   - alert_death_trends_thresholds.png  : same, PNG version
...
save_alert_trend_plot(
  p_case_overview,
  "alert_case_trends_thresholds.png",
  output_dir = adeq_output_dir,
  width = overview_width, height = overview_height
)
...
message("  -> ", file.path(adeq_output_dir, "alert_case_trends_thresholds.png"))
...
save_alert_trend_plot(
  p_death_overview,
  "alert_death_trends_thresholds.png",
  output_dir = adeq_output_dir,
  width = overview_width, height = overview_height
)
message("  -> ", file.path(adeq_output_dir, "alert_death_trends_thresholds.pdf"))
message("  -> ", file.path(adeq_output_dir, "alert_death_trends_thresholds.png"))
