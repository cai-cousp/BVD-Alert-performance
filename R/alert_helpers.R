...
# Project root paths
# Determine the EVD17 root directory robustly (supports standalone repo or nested location)
find_evd17_root <- function() {
  candidates <- c(
  ...
  normalizePath(file.path(here::here(), ".."))
}
evd17_root <- find_evd17_root()
...
source(here::here("alert_helpers/alert_map_geography.R"))
source(here::here("alert_helpers/alert_map_style.R"))
source(here::here("alert_helpers/notification_performance_map.R"))
