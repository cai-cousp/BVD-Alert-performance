# BVD Alert Performance — Analysis Pipeline & Interactive Dashboard

R analysis pipeline and interactive Shiny dashboard for the Ebola Virus Disease (EVD17 / BVD)
outbreak response in the Democratic Republic of the Congo.

The project computes weekly **alert thresholds** and **trend / adequacy metrics** per health zone
from multiple triangulated sources (baseline mortality, historical Beni benchmarks, and live case
surveillance), evaluates alert notification performance across health zones, and provides a
self-contained, webR-ready **interactive Shiny dashboard** deployed automatically via GitHub Pages.
